...
@SpringBootTest(properties={"spring.datasource.url=jdbc:h2:mem:notifications", "spring.datasource.driver-class-name=org.h2.Driver", "spring.datasource.username=sa", "spring.datasource.password=", "app.jwt.secret=test-secret-at-least-thirty-two-characters"})
